...
This project is in active MVP iteration. The collaboration core is functional and includes OT conflict handling, remote cursor presence, and snapshot persistence.
